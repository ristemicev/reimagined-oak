<div class="card">
    <div class="card__img text-center">
        <a href="{{ route('event.show', ['id' => $event->id]) }}" class="card__link">
            @if ($event->hasImage('event', 'default'))
            <img width="100%" src="{{$event->image('event', 'default')}}" alt="">
            @else
            <svg xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" xml:space="preserve"
                ...
                <g>
                    ...
                    <g>
                        ...
                        <polygon points="40,58.5 31.6,72.6 34.6,78.2 37.9,75.2 43.5,79.9 47,78.2 51,75.2" class="st1">
                        </polygon>
                        <path
    ...
    <div class="card__subtitle">{{$event->title}}</div>
